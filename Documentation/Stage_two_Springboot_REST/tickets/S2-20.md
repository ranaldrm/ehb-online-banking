...
>
> Deposit and withdrawal endpoints are now available. Consider extending
> the successful scenario to include:
>
> ``` text
...
> POST a withdrawal
>     ↓
> GET that account again
>     ↓
> verify balance decreased
> ```
>
> This also gives you a natural way to fund an account before running
> the payment scenario above.
...
> **Note (added after deposit/withdrawal endpoints were implemented)**
>
> Also test failure paths through the new endpoints:
>
> ``` text
> POST /deposit with a zero or negative amount
> POST /withdraw with an amount exceeding the balance
> ```
>
> These should return structured error responses once S2-16 handlers are
> in place, not 500s.
